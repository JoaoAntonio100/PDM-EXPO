...
import Monstros from '@/components/Aves/aves';
import MonstrosModal from '@/components/modals/AvesModal'; 
import MonstrosScrollView from '@/components/MyScrollView';
    ...
    <MonstrosScrollView headerBackgroundColor={{ light: '#A1CEDC', dark: '#1D3D47' }}>
      <ThemedView style={styles.headerContainer}>
        <TouchableOpacity onPress={() => openModal()}>
          <Text style={styles.headerButton}>Adicionar Monstro</Text>
        </TouchableOpacity>
      </ThemedView>
